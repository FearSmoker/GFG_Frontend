              ...
              {isAuthenticated && user && (
                <div className="mb-8">
                  ...
                  <div className="flex justify-center">
                    <button
                      onClick={() => setShowLogoutCard(true)}
                      className="flex items-center justify-center px-6 py-3 rounded-lg border transition-all duration-300 bg-red-500/20 border-red-400/30 hover:bg-red-500/30 hover:border-red-400/50"
                      aria-label="Logout"
                    >
                      <img
                        src={logoutIcon}
                        alt="Logout"
                        className="h-5 w-5 filter brightness-0 saturate-100% invert(27%) sepia(51%) saturate(2878%) hue-rotate(346deg) brightness(104%) contrast(97%)"
                      />
                      <span className="ml-2 text-red-400 text-sm font-medium">Logout</span>
                    </button>
                  </div>
                </div>
              )}
