...
export default function GeekFusion() {
    ...
    <>
      {isOpen && (
        <motion.div
          ...
          className="z-20 fixed top-73 md:w-80 right-6  flex items-center gap-4 bg-gradient-to-r  from-emerald-700   text-white p-4 sm:p-5 rounded-2xl shadow-xl max-w-xs sm:max-w-sm md:max-w-md"
        >
          {/* Illustration */}
