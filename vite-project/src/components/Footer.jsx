        ...
        <footer>
            ...
            <NeonText color={"mt-2 md:mt-5"} text={"GET IN TOUCH"}/>
             <div className="flex justify-center md:gap-10 gap-2 md:pt-5 pt-3">
                <button className="border-b-3  border-black  rounded-2xl px-3 bg-gradient-to-bl from-blue-400 to-emerald-500 font-bold  active:translate-y-0.5 active:border-b-2 ">Contact Us</button>
